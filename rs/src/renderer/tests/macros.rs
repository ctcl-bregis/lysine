...
fn macro_param_arent_escaped() {
    ...
    let result = lysine.render("hello.html", &context);
...
fn render_set_tag_macro() {
    ...
    .unwrap();
    let result = lysine.render("hello.html", &Context::new());
...
"#,
    ...
    let result = lysine.render("recursive", &context);
...
fn render_macros_in_included() {
    ...
    .unwrap();
    let result = lysine.render("example", &Context::new());
...
fn import_macros_into_other_macro_files() {
    ...
    .unwrap();
    let result = lysine.render("index", &Context::new());
...
fn can_inherit_macro_import_from_parent() {
    ...
    let result = lysine.render("child", &Context::default());
    assert_eq!(result.unwrap(), "HELLO".to_string());
}
