...
pub enum ForLoopKind {
    ...
    Value,
    // Loop over key value pairs, eg a `HashMap` or `Object` style ilysinetion
    KeyValue,
}
...
pub enum ForLoopValues<'a> {
    ...
    Array(Val<'a>),
    // Values for a per-character ilysinetion on a string
    String(Val<'a>),
    // Values for an object style ilysinetion
